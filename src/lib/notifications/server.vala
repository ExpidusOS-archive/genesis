namespace Genesis {
    ...
    public class NotificationDaemonServer {
        ...
        public void notify(Notification notif) throws GLib.DBusError, GLib.IOError {
        ...
        public Notification @get(uint32 id) throws GLib.DBusError, GLib.IOError, NotificationDaemonError {
            if (id >= this._next_id || id < 1) throw new NotificationDaemonError.INVALID_ID("ID must be greater than 0 and less than %lu", this._next_id);
