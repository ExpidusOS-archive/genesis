namespace GenesisShellGtk3 {
  public sealed class DashboardWindow : TokyoGtk.Window {
    private ulong _x_id;
    private ulong _y_id;
    ...
    internal DashboardWindow(GenesisShell.Monitor monitor) {
    ...
    construct {
      ...
      this._widget           = new DashboardWidget(this.monitor);
    ...
    private void update_position() {
      ...
      var edge = this.monitor.mode.width * 0.01;
      this.move((this.monitor.x + this.monitor.mode.width) - (int)(edge / 2), this.monitor.y + min_height + 10);
    }
